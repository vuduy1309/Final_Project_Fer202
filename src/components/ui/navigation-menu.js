...
function NavigationMenu(_a) {
    ...
    return (React.createElement(NavigationMenuPrimitive.Root, Object.assign({ "data-slot": "navigation-menu", "data-viewport": viewport, className: cn("group/navigation-menu relative flex max-w-max flex-1 items-center justify-center", className) }, props),
        children,
        viewport && React.createElement(NavigationMenuViewport, null)));
}
function NavigationMenuList(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(NavigationMenuPrimitive.List, Object.assign({ "data-slot": "navigation-menu-list", className: cn("group flex flex-1 list-none items-center justify-center gap-1", className) }, props)));
}
function NavigationMenuItem(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(NavigationMenuPrimitive.Item, Object.assign({ "data-slot": "navigation-menu-item", className: cn("relative", className) }, props)));
}
...
function NavigationMenuTrigger(_a) {
    ...
    return (React.createElement(NavigationMenuPrimitive.Trigger, Object.assign({ "data-slot": "navigation-menu-trigger", className: cn(navigationMenuTriggerStyle(), "group", className) }, props),
        children,
        " ",
...
function NavigationMenuIndicator(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement(NavigationMenuPrimitive.Indicator, Object.assign({ "data-slot": "navigation-menu-indicator", className: cn("data-[state=visible]:animate-in data-[state=hidden]:animate-out data-[state=hidden]:fade-out data-[state=visible]:fade-in top-full z-[1] flex h-1.5 items-end justify-center overflow-hidden", className) }, props),
